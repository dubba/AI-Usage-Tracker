...
- On mobile devices, the Link Devices modal now positions with a comfortable 20px clearance directly above the on-screen keyboard during code entry rather than pinning to the top ceiling, keeping the 6-digit input, Back to My QR, and Connect to Device buttons easily reachable near your thumbs.
