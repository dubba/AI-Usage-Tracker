...
- On mobile devices, the Link Devices modal now positions with a comfortable 20px clearance directly above the on-screen keyboard during code entry rather than pinning to the top ceiling, and standardizes 20px vertical spacing between the instructions, digits input box, Wi-Fi guidance note, security badge, and action buttons.
