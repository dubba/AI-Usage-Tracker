...
- On mobile devices, the Link Devices modal now automatically shifts upward when the on-screen keyboard appears during code entry, aligning below the top status bar safe area and compacting code entry vertical spacing so the Back to My QR and Connect to Device buttons remain fully visible above the keyboard with ample breathing room.
